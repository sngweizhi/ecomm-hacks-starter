...
[Brief explanation of your architecture and how you're using Nano Banana Pro and
Gemini 3 Pro]
...
- Set `EXPO_PUBLIC_GEMINI_API_KEY` for the Gemini Live camera overlay (bounding
  boxes).
